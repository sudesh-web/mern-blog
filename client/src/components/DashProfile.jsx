...
import { updateStart, upadateSuccess, updateFailure, deleteUserStart, deleteUserSuccess, deleteUserFailure, signoutSuccess } from '../redux/user/userSlice';
...
export default function DashProfile() {
  ...
  const uploadImage = async () => {
    ...
    ////////const storage= getStorage(cloudinary);
